...
class OrgVolReqHistoryPage extends StatefulWidget {
  final String volunteerId; // Placeholder for userId
  const OrgVolReqHistoryPage({super.key, required this.volunteerId});
  
  @override
  OrgVolReqHistoryPageState createState() => OrgVolReqHistoryPageState();
}

class OrgVolReqHistoryPageState extends State<OrgVolReqHistoryPage> {
                            ...
                            return RequestBox(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => OrgVolReqDetailsPage(requestId: request.id),
                                  ),
                                );
                              },
                            );
